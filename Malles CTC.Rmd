...
malla_CTC1S1 <- ggplot(data = CTC1S1, aes(x = station, y = departure, group = train_number)) +
  ...
  coord_cartesian(expand = FALSE, xlim = c(0.9, 18.1), ylim = c(ymd_hms("1899-12-31 00:00:00"),ymd_hms("1900-1-1 01:00:00"))) +
  labs(
    x = "Estació",
    y = "Hora",
...
```{r generador_grafics}
ggsave(here("malles", "CTC1S2.jpg"), plot = malla_CTC1S2, dpi = 300,  width = 40, height = 80, units = "cm") ##This saves last graph run
